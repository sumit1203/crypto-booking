...
/**
   ...
   tokens.
   Uses OpenZeppelin StandardToken, BurnableToken, MintableToken and PausableToken.
 */
contract LifTokenTest is StandardToken, BurnableToken, MintableToken, PausableToken {
  ...
  // Max Lif faucet (5000 tokens)
  uint256 public constant MAX_LIF_FAUCET = 5000000000000000000000;
