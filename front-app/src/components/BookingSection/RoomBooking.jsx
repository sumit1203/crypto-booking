...
export default class RoomBooking extends React.Component {
  render() {
    ...
    return (
      <div id='BookARoom' style={{ margin: 'auto', width: '500px' }}>
        <h2>
            Book a Room
        </h2>
        <p>
        ...
        <form onSubmit={onSubmit}>
          ...
          <Section>
            ...
            <input className="form-control form-control-lg" id="guestAddress" style={{ marginRight: '5px' }} type="text" onChange={onAddressChange} />
          </Section>
          <Section>
            <div style={{ display: 'inline-block', marginRight: 32 }}>
              ...
              <input className="form-control form-control-lg" id="fullName" style={{ marginRight: '5px' }} type="text" onChange={onFullNameChange} />
            ...
            <div style={{ display: 'inline-block' }}>
              ...
              <input className="form-control form-control-lg" id="email" style={{ marginRight: '5px' }} type="email" onChange={onEmailChange} />
              <label htmlFor="phone" style={labelBlockStyle}>
                  Phone Number
              </label>
              <input className="form-control form-control-lg" id="phone" style={{ marginRight: '5px' }} type="tel" onChange={onPhoneChange} />
            </div>
          </Section>
          <Section>
