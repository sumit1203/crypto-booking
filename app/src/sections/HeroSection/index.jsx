      ...
      <div className="container">
        <div className="row">
          <div className="col text-center">
            <img
              src={LogoEB}
              className="hero__footer__logo d-block d-md-inline-block mx-auto mb-1 mb-md-0"
              width="150"
              alt="ETH Berlin"
            />
            <span className="mx-1 h5 d-none d-md-inline hero__footer__logo__dot">
              •
            </span>
            <span className="h5 d-block d-sm-inline mb-sm-0">
              September 7 – 9, 2018
            </span>
            <span className="mx-1 h5 d-none d-sm-inline">
              {'//'}
            </span>
            <span className="h5 d-block d-sm-inline mb-sm-0">
              Berlin.
            </span>
            <span className="mx-1 mb-0 btn btn-sm btn-warning">
