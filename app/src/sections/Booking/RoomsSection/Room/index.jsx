...
class Room extends React.Component {
  ...
  render() {
    ...
    const {
      images, price, description, isFull, amenities, id, lifPrice, ethPrice,
    } = room;
    return (
      <React.Fragment>
          ...
          <header className="card-title">
            ...
            <div className="d-none d-lg-block">
              <div className="row align-items-center">
                <h4 className="col-sm-12 col-md-8">
                  {roomIndex === 0 ? ' King-size Bed' : roomIndex === 1 && ' Twin Bed'}
                </h4>
          ...
          <ul className="nav nav-tabs my-1" role="tablist">
            <li className="nav-item">
              <a
                ...
                id={`description-tab-${roomIndex}`}
                data-toggle="tab"
                href={`#description-${roomIndex}`}
                role="tab"
            ...
            <li className="nav-item">
              <a
                className="nav-link"
                id={`amenities-tab-${roomIndex}`}
                data-toggle="tab"
                href={`#amenities-${roomIndex}`}
                role="tab"
        ...
        && (
          <div className="card-footer text-center text-md-left">
            <AnchorLink
              href="#book-a-room"
              className={classnames('btn btn-secondary mb-1 mb-md-0', { disabled: isFull })}
