      ...
      <div className="row justify-content-center">
        <div className="col-md-8">
          ...
          <div className="card-deck">
            ...
            <a href="https://idex.market/" className="card card-sm">
            ...
            <a href="http://yobit.io/" className="card card-sm">
              <div className="card-header d-none d-md-block text-center">
            ...
            <a href="https://openledger.info/" className="card card-sm">
              <div className="card-header d-none d-md-block text-center">
            ...
            <a href="https://forkdelta.github.io/" className="card card-sm">
              <div className="card-header d-none d-md-block text-center">
